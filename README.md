Banking Automation Project based on Python created using tkinter, gmail, pillow and other standard libraries. Also, incorporated SQlite database to save customer account data.
Prerequisites:
